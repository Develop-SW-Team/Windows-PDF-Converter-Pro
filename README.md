...
Basic Workflow
    ...
    Select Conversion Type from the left panel

    Add Files using the "Add Files" or "Add Folder" buttons

    Configure Options:

        Choose quality level (Maximum/High/Medium/Low)

        Select output folder

        Enable/disable date-based subfolders

    Start Conversion - Click the green "START CONVERSION" button

    Review Results - Status indicators show success/failure
